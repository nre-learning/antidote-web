...
templates:
	...
	@cd src/main/webapp-templates/ && virtualenv venv/ && source venv/bin/activate && pip install -r build-requirements.txt && python generate_webapp.py $$(git rev-parse HEAD)
